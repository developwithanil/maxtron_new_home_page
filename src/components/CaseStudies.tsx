          ...
          <div className="flex flex-row md:flex-col items-center text-center relative  md:min-h-[400px] justify-between py-6 md:py-0 w-full ">
            ...
            <div className="flex flex-col justify-center items-center flex-grow px-2 md:px-0">
              ...
              >
                ...
                <div className="flex flex-wrap justify-center gap-x-2.5 gap-y-1 mb-4">
                  {currentStudy.tags.map((tag, index) => (
                    <span
                      key={index}
                      className="text-[12px] sm:text-[14px] font-semibold text-[#7A35C1] font-[switzer] tracking-wider"
                    >
                      {tag}
              ...
              <a
                ...
                className="w-fit flex gap-1 items-center px-4 py-2.5 sm:px-7 sm:py-3 md:py-3 border-2 border-[#7A35C1] text-[#7A35C1] font-semibold rounded-xl hover:bg-[#7A35C1] hover:text-white transition-all duration-300 group text-sm sm:text-base md:text-lg shadow-md text-center"
              >
                Learn More
