...
const CaseStudies = () => {
  ...
  return (
    <section
      id="case-studies"
      className="relative  md:py-24 bg-brand-bg-dark text-brand-text-light"
    >
      <div className="container mx-auto  p-5 md:p-4 lg:p-4 xl:p-4 ">
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col items-center text-center relative min-h-[350px] md:min-h-[400px] justify-between py-6 md:py-0">
            ...
            <a
              ...
              className="inline-flex items-center px-2 md:px-7 py-2 md:py-4 border-2 border-[#7A35C1] text-[#7A35C1] font-semibold rounded-xl hover:bg-brand-purple hover:text-[#7A35C1] transition-all duration-300 group text-sm md:text-lg shadow-md"
            >
              Learn More
