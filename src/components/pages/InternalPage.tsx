...
const InternalPage: React.FC<InternalPageProps> = ({ caseStudies }) => {
  ...
  // Assume you have a way to get the current page slug or id, e.g., from useParams
  const slug = "dynamic-slug"; // Replace with actual slug logic
  const canonicalUrl = `https://www.maxtron.ai/internal/${slug}`;
  return (
    <>
      <Helmet>
        <title>Internal Page | Maxtron</title>
        <meta name="description" content="Maxtron internal page for detailed information." />
        <link rel="canonical" href={canonicalUrl} />
        <meta name="robots" content="index, follow" />
        <meta httpEquiv="X-Robots-Tag" content="index, follow" />
        <meta property="og:title" content="Internal Page | Maxtron" />
        <meta property="og:description" content="Maxtron internal page for detailed information." />
