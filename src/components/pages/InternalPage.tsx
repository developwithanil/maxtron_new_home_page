...
const ProcessSteps: React.FC<{ processSteps: CaseStudy['processSteps'] }> = ({ processSteps }) => (
                ...
                {step.description.length > 0 && step.description[0] !== "" && (
                    <ul className="list-disc pl-6 mt-4">
                        {step.description.map((desc, idx) => (
                            desc !== "" && <li key={idx} className="mb-2 text-sm">{desc}</li>
                        ))}
                    </ul>
                )}
            </div>
            ...
            <div className="container mx-auto mt-8 flex flex-wrap lg:flex-nowrap">
                ...
                <div className="w-full lg:w-[70%] p-4 lg:p-0">
                    ...
                    {problemSolutionResult.map((section, index) => (
                        <div key={index} className="mb-10 pb-10 border-b border-gray-200 last:border-b-0 last:mb-0 last:pb-0">
                            <h2 className="text-2xl font-bold mb-6">{section.heading}</h2>
                            {section.subheading && <h3 className="text-xl font-semibold mb-4">{section.subheading}</h3>}
            ...
            <div className="container mx-auto py-12">
                <div className="flex mx-4 flex-wrap lg:flex-nowrap items-center justify-between">
                    ...
                    <div className="w-full lg:w-2/3">
                        ...
                        <div className="container mx-auto py-12">
                            <h2 className="text-3xl font-bold mb-8">{caseStudy.theprocessText}</h2>
