  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Maxtron delivers advanced Artificial Intelligence solutions to accelerate your business growth with cutting-edge technology." />
        <link rel="canonical" href="https://www.maxtron.ai/artificial-intelligence" />
        <meta name="robots" content="index, follow" />
        <meta httpEquiv="X-Robots-Tag" content="index, follow" />
        <meta property="og:title" content="Artificial Intelligence | Maxtron" />
        <meta property="og:description" content="Maxtron delivers advanced Artificial Intelligence solutions to accelerate your business growth with cutting-edge technology." />
        <meta property="og:image" content="https://www.maxtron.ai/src/assets/MaxtronLogo.png" />
        <meta property="og:url" content="https://www.maxtron.ai/artificial-intelligence" />
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 px-4 sm:px-6 md:px-12 lg:px-16 xl:px-20 py-12 lg:py-20">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left flex flex-col justify-center">
            <h1 className="text-3xl sm:text-4xl font-[Switzer] md:text-5xl lg:text-5xl font-black leading-[126%] text-[#1A1A1A] tracking-tight mb-8">
              Intelligence that Builds, Powers, and Grows Brands
            </h1>
