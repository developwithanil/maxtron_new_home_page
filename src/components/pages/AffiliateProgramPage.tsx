...
const items = [
  {
    ...
    description:
      "Get rewarded for real value. Unlike most programs, we pay based on actual deal closures, meaning higher payouts—often $1,000+ per referral.",
  },
  {
    icon: report,
    title: "Transparent Tracking & Reporting",
    description:
      "Stay in control with real-time dashboards, performance insights, and clear attribution across the full sales cycle.",
  },
  {
    icon: offer,
    title: "Premium B2B Offerings",
    description:
      "We specialize in advanced innovation solutions for mid-to-enterprise-level companies—giving you the opportunity to earn from high-value deals with long-term customers.",
  },
];
...
const items2 = [
  {
    title: "Apply to Join",
    description:
      "Submit your info and promotion plan. We'll review and respond within 2–3 business days.",
  },
  {
    title: "Get Approved & Onboarded",
    description:
      "Once approved, you'll gain access to your affiliate dashboard, links, and custom assets.",
  },
  {
    title: "Refer & Promote",
    description:
      "Use your unique tracking link to refer companies to Maxtron. We provide sales collateral, email templates, and more.",
  },
  {
    title: "Earn Commission",
    description:
      "When your referral signs and pays, you'll earn up to 30% of the deal value. It's that simple.",
  },
];
...
const AffiliateProgramPage = () => {
  return (
    <>
      <Helmet>
        <title>Affiliate Program | Maxtron</title>
        <meta name="description" content="Join Maxtron's Affiliate Program and earn rewards by promoting our innovative IT and marketing solutions." />
        <link rel="canonical" href="https://www.maxtron.ai/affiliate" />
        <meta name="robots" content="index, follow" />
        <meta httpEquiv="X-Robots-Tag" content="index, follow" />
        <meta property="og:title" content="Affiliate Program | Maxtron" />
        <meta property="og:description" content="Join Maxtron's Affiliate Program and earn rewards by promoting our innovative IT and marketing solutions." />
        <meta property="og:image" content="https://www.maxtron.ai/src/assets/MaxtronLogo.png" />
        <meta property="og:url" content="https://www.maxtron.ai/affiliate" />
      ...
      <div className="w-full">
        <div className="w-full max-w-[96rem] mx-auto pl-4 sm:pl-7 md:pl-12 xl:pl-14 py-4 sm:py-6 md:py-8 lg:py-10 xl:py-12 ">
          <div className="flex flex-col-reverse lg:flex-row gap-5 sm:gap-7 md:gap-9 lg:gap-10">
            <div className="flex-1 flex flex-col  justify-center items-start px-1 sm:px-2 md:px-3 lg:px-5 xl:px-7 gap-4 md:gap-5 lg:gap-6 xl:gap-8">
              <div className="flex flex-col gap-1 sm:gap-2">
                <h1 className=" font-[Switzer] text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-medium leading-[110%] mb-2">
                  Turn your network into
                </h1>
                <h1 className="text-[#2A2A2A] font-[Switzer] text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-medium leading-[110%]">
                  <span className="flex items-center gap-2 flex-wrap">
                    <span className="bg-[#F3EBFC] px-[7px] lg:px-[11px] py-1 rounded-xl text-[#7A35C1] text-center w-fit">
                      revenue
                    </span>
                    with
                    <span className="flex items-center bg-white shadow-[0px_4px_10px_0px_rgba(0,0,0,0.14)] px-2 lg:px-4 py-1 rounded-xl">
                      <img
                        src={darkFullLogo}
                        alt="Maxtron logo"
                        className="w-[110px] md:w-[130px] lg:w-[141.857px] h-9 md:h-10 lg:h-12"
                      />
                    </span>
                  </span>
                </h1>
          ...
          <div className="w-full  mt-14 md:mt-20 lg:mt-28 xl:mt-36 pr-3 md:pr-4 lg:pr-8">
            <h2 className="self-stretch text-[#2A2A2A]  font-[Switzer] text-2xl lg:text-3xl xl:text-4xl font-semibold leading-[140%] text-center mt-8 md:mt-10 lg:mt-12 xl:mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7 mt-7 md:mt-10 lg:mt-12 xl:mt-16 ">
              {items.map((item, index) => (
                ...
                >
                  ...
                  <p className=" text-[#213343] font-lexendDeca text-sm lg:text-base font-light leading-7 pr-4">
                    {item.description}
                  </p>
                </div>
              ))}
          ...
          <div className="w-full flex flex-col lg:flex-row gap-8 mt-14 md:mt-20 lg:mt-28 xl:mt-36 pr-3 md:pr-4 lg:pr-8">
            ...
            <div className="w-full lg:w-[40%] text-center lg:text-start">
              ...
              <p className="text-[#2A2A2A] font-openSansHebrew text-lg lg:text-xl font-normal leading-8">
                If you have an audience, influence, or insider industry knowledge,
