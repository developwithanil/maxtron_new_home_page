...
const NewHomePage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Creating Winning Companies and Making Them Successful | Best Digital Product Engineering & Consulting Services | Maxtron.ai
        </title>
        ...
        <meta
          property="og:title"
          content="Creating Winning Companies and Making Them Successful | Best Digital Product Engineering & Consulting Services  | Maxtron.ai"
        />
        <meta
