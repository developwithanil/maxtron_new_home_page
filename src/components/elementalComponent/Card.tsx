...
const Card: React.FC<CardProps> = ({ title, description, imageUrl }) => {
  return (
    <div
      ...
      className=" text-[#1E1E1E] bg-cover bg-[#FFEFFC] bg-center p-4 rounded-xl shadow-lg transform transition-transform duration-300 hover:scale-110 hover:shadow-xl"
    >
      <div className="flex flex-col items-start pl-2 pt-1">
        ...
        <h3 className="text-xl text-[#4E009C] font-OpenSans text-left font-bold">{title}</h3>
