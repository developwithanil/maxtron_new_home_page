...
const faqs = [
  {
    question: "Is AI adoption regulated or restricted in any way in India?",
    answer: (
      <>
        <p>
          There are increasing regulations around data privacy, usage of
          personal data, ethics, and bias. We ensure all our solutions comply
          with applicable laws and adopt best practices.
        </p>
      </>
    ),
  },
  {
    question: "What kind of ROI can one expect from AI solutions?",
    answer: (
      <>
        <p>
          Depending on the use-case, ROI can come through cost reduction,
          process automation, improved decision making, customer satisfaction,
  ...
  },
  {
    ...
    answer: (
      <>
        <p>
          Small prototypes / POCs can be done in weeks (4-8 weeks), whereas
          complex systems with multi-modal data or integration across
          departments may take several months.
        </p>
      </>
    ),
  },
