    ...
    <div className="flex flex-col w-full 2xl:mx-auto max-w-[88rem] items-start  py-4 md:py-6 lg:py-8 px-6 lg:px-0">
      <div className="flex flex-col lg:flex-row w-full">
        <div className="lg:w-1/2 w-full   flex flex-col items-center  bg-[rgba(217,217,217,0.20)] justify-start">
          <div className="w-full flex  items-center self-stretch bg-[#8941C4] py-8 px-4 ">
            <p className="text-white [font-family:Switzer] text-5xl font-bold leading-[120%]">
              BUSINESS NEED
            </p>
          </div>
        ...
        <div className="lg:w-1/2 w-full  flex flex-col items-center bg-[rgba(217,217,217,0.20)] justify-start">
          <div className="w-full flex  items-center self-stretch bg-[#8941C4] py-8 px-4 border-l-[rgba(0,0,0,0.20)] border-l border-solid">
            <p className="text-white [font-family:Switzer] text-5xl font-bold leading-[120%]">
              RESULT
            </p>
          </div>
