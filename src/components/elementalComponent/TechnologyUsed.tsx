    ...
    >
      <div>
        <div className="p-5 md:p-4 lg:p-4 xl:p-4">
          <h2 className="text-2xl lg:text-5xl font-bold text-[#2A2A2A] mb-8 text-[Switzer]">
                ...
                <div className="py-4 flex flex-row justify-between">
                  ...
                  <div className="flex mt-4 items-center">
                    {card.link ? (
                      ...
                      <div className="text-[#BEBCCA] cursor-not-allowed">
                        <div className="bg-[#F8F8F8] md:border border-[#BEBCCA] flex items-center gap-2 px-4 py-3 rounded-md">
                          <p className="hidden md:block">{card.linktitle}</p>
                          <svg
                            className="block md:hidden"
                            width="24"
