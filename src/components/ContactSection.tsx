...
const ContactSection = () => {
  return (
    <div className="bg-gray-900 text-white p-6 md:p-16 relactive  space-y-4 -mb-52 m-4 rounded-3xl border-4 solid border-[#BDBCBC] flex flex-col md:flex-row justify-between items-center">
      ...
      <div className="flex flex-col items-start">
        <div className="mb-4">
          <p className="font-normal">
            <span className="font-bold">Address:</span> 6, Sunworld Arista,
            Sector 168, Noida, India
          </p>
        </div>
        <div className="mb-4">
          <p>
