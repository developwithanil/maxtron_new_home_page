...
const AllCrpto = () => {
    return (_jsx("div", { className: " flex items-center justify-center gap-4 md:gap-5 lg:gap-7", children: items.map((item, index) => (_jsx("div", { children: _jsx("img", { src: item, alt: "item", className: "w-10 lg:w-12 h-10 lg:h-12" }) }, index)
        // <div key={index}>
