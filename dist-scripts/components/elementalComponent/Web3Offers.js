...
const cardsData = [
    {
        ...
        description: "Automate KYC, AML and user onboarding with intelligent workflows that adapt to chain-level data and regional compliance.",
    },
    {
        id: 2,
        number: 2,
        title: "Smart Contract Monitoring & Alerts",
        description: "Stay ahead of exploits, governance shifts or suspicious behaviors via real-time contract analytics and AI-trained anomaly detection.",
    },
    {
        id: 3,
        number: 3,
        title: "Cross-Chain Data Intelligence",
        description: "Unified dashboards and AI summarization across Ethereum, Solana, BNB and more - so you don’t have to choose just one ecosystem.",
    },
    {
        id: 4,
        number: 4,
        title: "No-Code Web3 Integrations",
        description: "Plug-and-play modules for integrating wallets, NFTs, on-chain activity tracking and DeFi protocols into your platform - no developer bottleneck.",
    },
    {
        id: 5,
        number: 5,
        title: "Governance Automation",
        description: "Automate DAO proposals, voter notifications or treasury disbursements with customizable triggers and GPT-powered decision-making summaries.",
    },
    {
        id: 6,
        number: 6,
        title: "End-to-End Design & Development",
        description: "From user-centric dApp design to scalable smart contract architecture - Maxtron builds Web3 products that perform, engage and scale.",
    },
];
const Web3Offers = () => {
