...
export const caseStudies = [
    ...
    },
    {
        ...
        processSteps: [
            {
                title: "Advanced algorithms to facilitate model refinement and continued inference",
                description: [""],
            },
            {
            ...
            {
                title: "Development of a user-friendly interface (UI) and a comprehensive Software Development Kit (SDK)",
                description: [""],
            },
        ],
        keyFeatures: [
